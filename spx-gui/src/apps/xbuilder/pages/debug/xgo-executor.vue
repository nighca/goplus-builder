...
<template>
  <main class="mx-auto max-w-2xl p-8">
    ...
    <UICard class="p-6">
      <div class="flex gap-3"><UIButton type="primary" @click="runPlain">Run plain XGo</UIButton><UIButton type="secondary" @click="runTutorial">Run tutorial course</UIButton><UIButton type="neutral" @click="stop">Stop</UIButton></div>
